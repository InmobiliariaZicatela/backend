  ...
  attributes: {
    ...
    > &
      ...
      Schema.Attribute.SetMinMax<
        ...
        number
      >;
    Contacto: Schema.Attribute.Component<'secciones.contacto', false> &
      Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    Hero: Schema.Attribute.Component<'secciones.hero', false> &
      Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    > &
      Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    quienes_somos: Schema.Attribute.Component<'secciones.encabezado', false> &
      Schema.Attribute.Required;
    Testimonios: Schema.Attribute.Component<'testimonios.testimonio', true> &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMax<
        {
          max: 3;
        ...
        number
      >;
    ultima_llamada: Schema.Attribute.Component<
      'secciones.ultima-llamada',
      false
    > &
      Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiPropiedadPropiedad extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Required;
    colonia: Schema.Attribute.Component<'colonias.colonia', false> &
      Schema.Attribute.Required;
    coordenadas_mapa: Schema.Attribute.String & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    precio: Schema.Attribute.Integer &
      ...
      Schema.Attribute.SetMinMax<
        ...
        number
      >;
    precio_2: Schema.Attribute.Integer &
      Schema.Attribute.SetMinMax<
        {
          min: 0;
        },
